...
export class EndingScene extends Phaser.Scene {
    ...
    startEndingWalk() {
        // --- Sobrescrita de Física (Modo Cutscene) ---
        // Retiramos o controlo do utilizador e desativamos as restrições físicas padrão
        // (como gravidade e colisão com os limites da câmara). O jogador passa a atuar
        // como um "ator" roteirizado, caminhando na direção oposta (esquerda)
        // para simbolizar o regresso de onde veio.
        ...
        this.time.delayedCall(5000, () => {
            ...
            this.cameras.main.once('camerafadeoutcomplete', () => {
                ...
                // Remove o fade para podermos ver o novo texto
