...
export class Player extends Phaser.Physics.Arcade.Sprite {
    ...
    constructor(scene, x, y) {
        ...
        // --- Configuração da Hitbox Físico ---
        // Como a sprite base possui muito espaço vazio, recalculamos o offset e o tamanho
        // do corpo físico (body) para envolver apenas a silhueta real do personagem.
        // Isso garante precisão nas colisões mesmo após a aplicação do scaleFactor (2x).
    ...
    updatePlayerState() {
        // Máquina de Estados (FSM) Simplificada:
        // Avalia as condições físicas atuais (contato com o chão, velocidade) e transita 
        // o jogador para o estado correto, bloqueando temporariamente inputs conflitantes.
    ...
    tryDropPlatform() {
        ...
        let canDrop = false;
        this.scene.passablePlatforms.getChildren().forEach((plat) => {
    ...
    initiateAttack(animKey) {
        ...
        const attackListener = (anim, frame) => {
            ...
            // Controle Dinâmico de Hitbox:
            // A caixa de dano só é ativada nos frames exatos de impacto da animação
            // e se ajusta em tamanho e posição dinamicamente (Ex: Especial vs Aéreo).
